...
async def service_selection_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await safe_edit_message(query, text, reply_markup=countries_for_service_keyboard(service), parse_mode='HTML')
...
async def back_to_services_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await safe_edit_message(query, text, reply_markup=services_keyboard(), parse_mode='HTML')
